...
Author URI: https://supsystic.com/plugins/maintenance-mode-plugin/
Plugin URI: https://supsystic.com/plugins/maintenance-mode-plugin/
Tags: Maintenance Mode, Maintenance Mode page, construction, contest landing page, countdown, free landing page templates, landing page, launch, launch page, maintenance, maintenance mode, maintenance page, offline, unavailable, under construction, underconstruction, wordpress Maintenance Mode, wordpress maintenance mode, wordpress under construction
Tested up to: 6.2
Requires PHP: 7.4
Stable tag: 1.7.13
License URI: https://supsystic.com/plugins/maintenance-mode-plugin/
 
Maintenance Mode page with drag-and-drop builder or under construction |  maintenance mode to notify visitors and collects emails. Maintenance Mode templates

== Description ==

Choose professional Maintenance Mode template and edit content with drag-and-drop builder to show your visitors that you website is under construction or maintenance mode. Collect emails, get social likes and shares. Launch page becomes easy with [Maintenance Mode WordPress plugin](http://supsystic.com/plugins/coming-soon-plugin "Maintenance Mode WordPress plugin") by Supsystic

= Maintenance Mode Features =

* Professional [Maintenance Mode Templates](https://supsystic.com/maintenance-mode-page-templates/ "Maintenance Mode Templates")
* Responsive Design
...
* Maintenance Mode page [examples](https://supsystic.com/coming-soon-page-templates/ "Maintenance Mode Page Templates")

= How Maintenance Mode Page Works =

While your site is under construction, Maintenance Mode page allows you to set up landing page that users will be directed to when visiting any of your site page. The [Maintenance Mode by Supsystic](https://supsystic.com/plugins/maintenance-mode-plugin/ "Maintenance Mode plugin") plugin has three modes, "Maintenance Mode", "Maintenance / Under Construction" and "Redirect".
...
Build video landing pages and Maintenance Mode pages with the [Maintenance Mode by Supsystic](https://supsystic.com/plugins/maintenance-mode-plugin/ "Maintenance Mode by Supsystic") plugin. Putting a Video on a landing page or Maintenance Mode page is agreat way for helping visitors get your message clearly. The best way to build a video landing page or Maintenance Mode page is to host the video on a video hosting site like youtube.com or Vimeo. Then embed the video in your landing page or Maintenance Mode page.
...
You have an incredible opportunity to get PRO version of the Maintenance Mode / under construction plugin for free. Just make translation of the [Maintenance Mode by Supsystic](https://supsystic.com/plugins/maintenance-mode-plugin/ "Maintenance Mode by Supsystic") plugin!
...
Complete tutorial [How to create your first Maintenance Mode page](https://supsystic.com/documentation/getting-started-coming-soon/ "How to create your first Maintenance Mode page")

= Where is documentation for Maintenance Mode by Supsystic WP plugin? =
Here it is [Maintenance Mode Documentation](https://supsystic.com/docs/maintenance-mode/ "WordPress Maintenance Mode plugin documentation")

= How to use template blocks? =
[On this page](https://supsystic.com/documentation/coming-soon-blocks/ "Template blocks") you will find instuctions about using template blocks for Maintenance Mode page creating



== Screenshots ==

1. [Maintenance Mode Templates](http://supsystic.com/coming-soon-page-templates/ "Maintenance Mode Templates")

2. Maintenance Mode and Under Construction mode plugin admin area

3. [Maintenance Mode Templates](https://supsystic.com/plugins/maintenance-mode-plugin/#examples "Maintenance Mode WordPress Templates")

4. [Maintenance Mode Page](https://supsystic.com/plugins/maintenance-mode-plugin/ "Maintenance Mode Page WordPress plugin") Template Design
...
= 1.0.1 / 07.09.2015 =
 * Release Maintenance Mode by Supsystic on WordPress.org
